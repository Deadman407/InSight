"""deptt_management_system URL Configuration
...
from deptt_management_app import views, HodViews, StaffViews, StudentViews
from deptt_management_app.EditResultVIewClass import EditResultViewClass
from deptt_management_system import settings
